...
pdf.drawString(2.75*inch, 9.75*inch, "Data do Relatório: 27 de Fevereiro de 2023")

pdf.setFont("Helvetica-Bold", 12)
pdf.drawString(3.50*inch, 9.25*inch, "Código x Descrição")

y = 8.75*inch

for row in results:
    pdf.drawString(3.75*inch, y, str(row[0]))
    pdf.drawString(4.5*inch, y, str(row[1]))
    y -= 0.25*inch
