...
try:
    ...
    page_selection_label = tk.Label(
        page_selection_window, text="Digite as páginas que deseja separar (separadas por vírgulas):")
    ...
    def on_ok_button():
        ...
        output_filename = os.path.splitext(os.path.basename(file_path))[
            0] + "_pages_{}.pdf".format(pages_str.replace(',', '_'))
